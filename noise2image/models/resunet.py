"""
noise2image.models.resunet — lightweight residual U-Net fallback.

Used by :class:`noise2image.train.Model` when ``vanilla_unet=True``.
Not the architecture used for the Noise2Params paper (that is the
attention U-Net in :mod:`noise2image.models.unet_attention`), but
retained as a simpler-to-debug comparison point.
"""

"""
noise2image.np_transforms — NumPy-backed image transforms.

Vendored from the public pytorch-nptransforms project:
https://github.com/mlagunas/pytorch-nptransforms

The Noise2Params training pipeline uses only :class:`RandomHorizontalFlip`
and :class:`RandomVerticalFlip`.  The other transforms here are retained
in case users adapt the pipeline; they are unmodified relative to the
upstream project.
"""
